...
class DonationAdminView(ModelView):
    ...
    column_list=('id','user_id','donor_name','amount','currency','donationDate','campaign_id','method','status','invoice_id','api_ref','created_at')
    column_labels=dict(user_id='User Id', amount='Amount', donor_name='Donor Name',currency='Currency', donationDate='Donation Date',method='Method',status='Status',invoice_id='Invoice',api_ref='API Ref',created_at='Created At')
    column_filters=column_list
